...
export const CometChatMessageInformation = (
  props: CometChatMessageInformationInterface,
) => {
  const {
  ...
  const receiptsList = (item) => {
    return (
      <View>
        ...
        {item['deliveredAt'] &&
          receipt('DELIVERED', localize('DELIVERED'), item['deliveredAt'])}
    ...
    return (
      <View style={[Style.viewContainer]}>
        <Image
          ...
          style={[Style.imageStyle, { tintColor: 'black' }]}
        />
      </View>
    );
  };
    ...
    >
      <View style={{ flexDirection: 'row' }}>
        ...
        <View style={{ flex: 1, alignItems: 'center' }}>
          <Text style={{ color: titleTextColor, ...titleTextFont }}>
            {title}
          </Text>
        </View>
      </View>
      ...
      <View>
        <Text
          style={{
            color: dividerTint || theme.palette.getAccent500(),
      ...
      <View
        style={[
          Style.divider,
          { backgroundColor: dividerTint || theme.palette.getAccent200() },
        ]}
      />
