...
import { AvatarStyleInterface, CometChatListStylesInterface, CometChatOptions, ImageType, ListItemStyleInterface } from '../shared';
...
export interface AddMembersConfigurationInterface extends Omit<CometChatAddMembersInterface, 'backButtonIcon' | 'emptyStateText' | 'errorStateText' | 'group'> {
}
export declare class AddMembersConfiguration {
