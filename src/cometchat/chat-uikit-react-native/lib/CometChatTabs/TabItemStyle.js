...
export class TabItemStyle extends BaseStyle {
    ...
    activeTabBorder;
    constructor({ activeTabBorder, activeBackgroundColor = "white", activeIconTint = "rgb(51, 153, 255)", activeTitleTextColor = "rgb(51, 153, 255)", activeTitleTextFont = new FontStyle({ fontSize: 16, fontWeight: "500" }), iconTint = "rgb(20, 20, 20)", titleTextColor = "rgb(20, 20, 20)", titleTextFont = new FontStyle({ fontSize: 16, fontWeight: "500" }), backgroundColor = "transparent", border = new BorderStyle({}), borderRadius = 0, height = 70, width = 70 }) {
        super({
            backgroundColor,
            border,
            borderRadius,
