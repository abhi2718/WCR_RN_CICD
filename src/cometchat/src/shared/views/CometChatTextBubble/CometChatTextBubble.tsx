...
export const FormatTextForLinks = ({ str, style }) => {
  let res = str.matchAll(
    phoneNumPattern + '|' + emailPattern + '|' + urlPattern,
  );
    ...
    return (
      <Text style={{ ...style.textFont, color: style.textColor }}>
        ...
        <Link
          ...
          style={{ ...style.linkTextFont, color: style.linkTextColor }}
        />
  ...
  return (
    <Text style={{ ...style.textFont, color: style.textColor }}>{str}</Text>
  );
};
