...
export const CometChatMediaRecorder = (
  props: CometChatMediaRecorderInterface,
) => {
  const {
    onClose,
    style,
  ...
  const _style = new MediaRecorderStyle({
    ...style,
    ...mediaRecorderStyle,
    submitIconTint: Boolean(recordedFile)
  ...
  useEffect(() => {
    NativeModules.FileManager.startRecording((filepath) => {
      console.log('Filepath startRecording', filepath);
    });
    startInterval();
    return () => {
  ...
  const _render = ({ item, index }) => {
    return (
      <View
        style={[
          Style.soundBar,
          audioBarTint && { backgroundColor: audioBarTint },
        ]}
      />
    );
  };
    ...
    <View style={Style.container}>
      <View style={[Style.soundBarContainer]}>
          ...
          <>
            {!recordedPlaying ? (
              <ImageButton
                ...
                imageStyle={[
                  Style.imageStyle,
                  playIconTint && { tintColor: playIconTint },
                ]}
                onClick={_onPlay}
              ...
              <ImageButton
                ...
                imageStyle={[
                  Style.imageStyle,
                  pauseIconTint && { tintColor: pauseIconTint },
                ]}
                onClick={_onPause}
                buttonStyle={[Style.buttonStyle, { width: '10%' }]}
              />
        ...
        <View
          style={[
            ...
            { flexDirection: Boolean(recordedFile) ? 'row-reverse' : 'row' },
          ]}
        >
          <Text
            style={[
      ...
      <View style={Style.buttonContainer}>
        <ImageButton
          ...
          imageStyle={[
            Style.imageStyle,
            closeIconTint && { tintColor: closeIconTint },
          ]}
          onClick={_onClose}
        ...
        {Boolean(recordedFile) ? (
          <ImageButton
            ...
            imageStyle={[
              Style.imageStyle,
              stopIconTint && { tintColor: stopIconTint },
            ]}
            onClick={_onStart}
            buttonStyle={[Style.buttonStyle]}
          />
        ...
        <ImageButton
          ...
          imageStyle={[
            Style.imageStyle,
            submitIconTint && { tintColor: submitIconTint },
          ]}
          onClick={_onSend}
