...
export class MessageDataSource implements DataSource {
  ...
  getTextMessageOptions(
    ...
    if (_isSentByMe || canEdit) msgOptions.push(this.getEditOption());
  ...
  getCommonOptions(
    ...
    if (
      isTextMessage(messageObject) ||
      isImageMessage(messageObject) ||
      isFileMessage(messageObject) ||
      isVideoMessage(messageObject) ||
      isAudioMessage(messageObject)
    ) {
    ...
    return new CometChatMessageTemplate({
      ...
      ContentView: (
        ...
        if (isDeletedMessage(message)) {
          ...
          return ChatConfigurator.dataSource.getFormMessageContentView(
            message,
            _alignment,
            theme,
          );
      ...
      options: (loggedInuser, message, group) =>
        ChatConfigurator.dataSource.getFormMessageOptions(
          loggedInuser,
          message,
          group,
        ),
    ...
    return new CometChatMessageTemplate({
      ...
      ContentView: (
        ...
        if (isDeletedMessage(message)) {
          ...
          return ChatConfigurator.dataSource.getCardMessageContentView(
            message,
            _alignment,
            theme,
          );
      ...
      options: (loggedInuser, message, group) =>
        ChatConfigurator.dataSource.getCardMessageOptions(
          loggedInuser,
          message,
          group,
        ),
