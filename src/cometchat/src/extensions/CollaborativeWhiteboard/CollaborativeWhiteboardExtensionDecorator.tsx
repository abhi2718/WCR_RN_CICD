...
export class CollaborativeWhiteboardExtensionDecorator extends DataSourceDecorator {
  ...
  constructor(
    ...
    textModerationConfiguration?: CollaborativeWhiteboardConfigurationInterface,
  ) {
    super(dataSource);
      ...
      if (
        ...
        return (
          <CometChatCollaborativeBubble
            ...
            url={url}
            style={
              this.whiteboardConfiguration &&
              this.whiteboardConfiguration.collaborativeBubbleStyle
            }
          />
        );
      }
