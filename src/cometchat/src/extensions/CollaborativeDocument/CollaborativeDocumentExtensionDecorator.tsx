...
export class CollaborativeDocumentExtensionDecorator extends DataSourceDecorator {
  ...
  constructor(
    ...
    docConfiguration?: CollaborativeDocumentConfigurationInterface,
  ) {
    super(dataSource);
  ...
  getLastConversationMessage(conversation: CometChat.Conversation): string {
    ...
    if (
      conversation.getLastMessage().getType() ==
        ExtensionTypeConstants.document &&
  ...
  getCollaborativeBubble(
        ...
        return (
          <CometChatCollaborativeBubble
            ...
            style={
              ...
              this.documentConfiguration.collaborativeBubbleStyle
            }
          />
        );
      }
    ...
    return (
      <View>
        <Text style={{ fontFamily: 'Urbanist-Regular' }}>{'no match'}</Text>
      </View>
    );
  }
}
