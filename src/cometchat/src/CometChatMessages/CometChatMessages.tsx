...
} from '../CometChatMessageList/MessageListConfiguration';
import {
  ChatConfigurator,
  CometChatContext,
...
} from '../CometChatThreadedMessages/ThreadedMessagesConfiguration';
import {
  CometChatDetails,
...
export const CometChatMessages = (props: CometChatMessagesInterface) => {
  ...
  const _composerConfiguration = new MessageComposerConfiguration({
    ...messageComposerConfiguration,
  });
  const _headerConfiguration = new MessageHeaderConfiguration({
    ...messageHeaderConfiguration,
  });
  const _listConfiguration = new MessageListConfiguration({
    ...messageListConfiguration,
  });
  const _threadedConfiguration = new ThreadedMessagesConfiguration({
    ...threadedMessagesConfiguration,
  });
  const _detailsConfiguration = new DetailsConfiguration({
    ...detailsConfiguration,
  });
  ...
  const threadedMessageInfo = useRef<{
    message: CometChat.BaseMessage;
    view: () => JSX.Element;
  }>({ message: null, view: () => null });
  const detailsData = useRef<{ user: CometChat.User; group: CometChat.Group }>({
    user: null,
    group: null,
  });
  ...
  useEffect(() => {
    CometChatUIEventHandler.addMessageListener(msgListenerId, {
  ...
  const { backgroundColor, height, width, border, borderRadius } =
    _messagesStyles;
