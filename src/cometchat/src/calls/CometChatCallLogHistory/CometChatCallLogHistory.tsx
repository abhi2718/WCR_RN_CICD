...
export const CometChatCallLogHistory = (
  ...
  const DefaultSubtitleView = ({ call }) => {
    ...
    return (
      <View style={[Style.row]}>
        ...
        <Text
          style={[
            { color: callStatusTextColor, marginStart: 2 },
            callStatusTextFont,
          ]}
        >
  ...
  const DefaultTailView = ({ call }) => {
    return (
      <View style={[Style.row, { alignItems: 'center' }]}>
        <Text
          style={[
            { color: callDurationTextColor, marginStart: 2 },
            callDurationTextFont,
          ]}
        >
          {CallUtils.convertMinutesToHoursMinutesSeconds(
            call['totalDurationInMinutes'],
          )}
        </Text>
      </View>
    );
